      ...
      return setInterval(() => {
        ...
        for (let i = 0; i < App.game.quests.currentQuests().length; i++) {
          let index = this._questPriorityList.indexOf(
            App.game.quests.currentQuests()[i].constructor.name
          );
          ...
          switch (this._currentQuest.constructor) {
            case BuyPokeballsQuest:
              ...
              if (
                App.game.wallet.hasAmount(
                  new Amount(
                    item.totalPrice(this._currentQuest.amount),
                    item.currency
                  )
                ) &&
                this._autoMove
                ...
                console.log(
                  `Need more gold before buying ${this._currentQuest.amount} ${itemName} or autoMove is false`
                );
                console.log(
                  `Missing ${item.totalPrice(this._currentQuest.amount)}` -
                    App.game.wallet.currencies[item.currency]()
                );
              }
              break;
            case DefeatDungeonQuest:
              ...
              if (Autopoke.dungeon !== undefined) {
                if (
                  ...
                  console.log(
                    "Not enough tokens or no access to the dungeon or autoMove is false"
                  );
                }
              } else {
            ...
            case DefeatGymQuest:
              ...
              if (
                ...
                console.log(
                  `Can't access ${this._currentQuest.gymTown.name} or autoMove is false`
                );
              }
              break;
            ...
            case CapturePokemonsQuest:
              ...
              if (itemName !== "") {
                if (
                  ...
                  if (
                    App.game.wallet.hasAmount(
                      new Amount(item.totalPrice(buyAmount), item.currency)
                    ) &&
                    this._autoMove
                  ) {
                    MapHelper.moveToTown(towns[0].name);
                    ...
                    console.log(
                      "All out of Balls and cant afford them or autoMove is false"
                    );
                  }
                }
              }
            ...
            case DefeatPokemonsQuest:
              ...
              if (
                this.helpFunctions.accessToRoute(route[1], route[0]) &&
                this._autoMove &&
                highestPrio ===
                  this._questPriorityList.indexOf(
                    this._currentQuest.constructor.name
            ...
            case GainShardsQuest:
              ...
              if (typeof this._mostEfficientPlace === "string") {
                ...
                if (
                  ...
                  console.log(
                    "Not enough tokens or no access to dungeon or autoMove is false"
                  );
                }
              } else {
                  ...
                  if (itemName !== "") {
                    if (
                      ...
                      if (
                        ...
                        console.log(
                          "All out of Balls and can't afford them or autoMove is false"
                        );
                      }
                    }
                  }
